...
straten       = pandas.read_csv(basedir + "data/addresses/straten1876.csv")
...
adressen = pandas.merge(adressen, straten, how='left', left_on='locatiepunt', right_on='locatiepunt')
